...
echo $form->textFieldRow($Model, 'surname', array(
    'class' => 'input-large _dictionaryForm_hideErrorsKeypress',
));
...
echo $form->textFieldRow($Model, 'middlename', array(
    'class' => 'input-large _dictionaryForm_hideErrorsKeypress',
));

echo $form->textFieldRow($Model, 'initials', array(
