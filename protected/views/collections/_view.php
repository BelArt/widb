...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('temporary')); ?>:</b>
	<?php echo CHtml::encode($data->temporary); ?>
	<br />

	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('has_preview')); ?>:</b>
	<?php echo CHtml::encode($data->has_preview); ?>
	<br />
